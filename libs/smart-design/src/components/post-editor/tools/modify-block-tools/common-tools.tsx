...
const MoveMenuItem = styled(S.MenuItem)<{ $disabled: boolean }>`
  color: ${({ $disabled, theme }) => $disabled && theme.common.disabledSurfaceColor} !important;
`;
...
export const CommonTools = memo<CommonToolsProps>(({ menuRefs, blockIndex, startingIndex }) => {
